...
const expressionTests = [
    ...
    { descr: `replace zero placeholder with numeral`, key: '6', expression: '0', result: '6' },
    { descr: `add operator to zero placeholder `, key: '\u00d7', expression: '0', result: '0\u00d7' },
    { descr: `add operator to negative zero placeholder `, key: '\u00d7', expression: '-0', result: '-0\u00d7' },
